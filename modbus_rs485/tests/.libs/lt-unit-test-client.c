...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Users/Feng/Documents/Project/SPR/libmodbus-3.1.4/libmodbus-3.1.4/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Users/Feng/Documents/Project/SPR/libmodbus-3.1.4/libmodbus-3.1.4/src/.libs:/usr/local/lib:/usr/local/bin:";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/cygdrive/c/Users/Feng/Documents/Project/SPR/libmodbus-3.1.4/libmodbus", f);
  fputs ("-3.1.4/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Users/Feng/Documents/Project/SPR/libmodbus-3.1.4/libmodbu", f);
  fputs ("s-3.1.4/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
